...
<script>
	...
	function dixian(){ 
		document.form1.action="line.php";
		document.form1.submit();
	}
	function message(){
		document.form1.action="message.php";
		document.form1.submit();
	}
</script>
</head>
...
?>
	...
	日期：<input class="Wdate" name="date" type="text" onClick="WdatePicker()"> <font color=red>&lt;- 单击弹出日期控件</font>
<input type="button" name="btn1" value="地线查询" onclick="dixian();">
<input type="button" name="btn2" value="短信查询" onclick="message();">
</form>
<?php
include "footer.html";
 ?>